    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime(2019, 7, 18, 20, 33, 50, 920767))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own', models.DateTimeField(default=datetime.datetime(2019, 7, 18, 20, 33, 50, 921764))),
                ('last_pay', models.DateTimeField(default=datetime.datetime(2019, 7, 18, 20, 33, 50, 921764))),
                ('squad', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='squads.Squad')),
            ],
            options={
                'verbose_name': 'Сектор',
