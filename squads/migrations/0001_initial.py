    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime(2019, 6, 25, 20, 47, 56, 102746))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(default=datetime.datetime(2019, 6, 25, 20, 47, 56, 103743))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own', models.DateTimeField(default=datetime.datetime(2019, 6, 25, 20, 47, 56, 104740))),
                ('last_pay', models.DateTimeField(default=datetime.datetime(2019, 6, 25, 20, 47, 56, 104740))),
                ('squad', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='squads.Squad')),
            ],
            options={
                'verbose_name': 'Сектор',
