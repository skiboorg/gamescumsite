    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime(2019, 6, 18, 9, 23, 42, 296594))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(default=datetime.datetime(2019, 6, 18, 9, 23, 42, 298594))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own', models.DateTimeField(default=datetime.datetime(2019, 6, 18, 9, 23, 42, 301589))),
                ('last_pay', models.DateTimeField(default=datetime.datetime(2019, 6, 18, 9, 23, 42, 301589))),
                ('squad', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='squads.Squad')),
            ],
            options={
                'verbose_name': 'Сектор',
