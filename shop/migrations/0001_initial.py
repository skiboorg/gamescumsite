    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('item', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.Items')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.IntegerField(default=0)),
                ('for_vip', models.BooleanField(default=False)),
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.Items', verbose_name='Основной товар')),
                ('set', models.ManyToManyField(blank=True, null=True, to='shop.Set', verbose_name='В составе сета')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.Orders'),
        ),
        migrations.AddField(
            model_name='itemsinorder',
            name='subitem',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.SubItem'),
        ),
        migrations.AddField(
            model_name='items',
            name='set',
