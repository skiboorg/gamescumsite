    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_zp', models.DateTimeField(default=datetime.datetime(2019, 7, 19, 20, 33, 50, 912789), verbose_name='Последняя ЗП')),
                ('date_joined', models.DateTimeField(default=datetime.datetime(2019, 7, 18, 20, 33, 50, 912789), verbose_name='Дата регистрации')),
                ('last_vizit', models.DateField(default=datetime.date(2019, 7, 18), verbose_name='Последний вход на сайт')),
                ('last_buy', models.DateField(default=datetime.date(2019, 7, 18), verbose_name='Последняя покупка')),
                ('vip_start', models.DateField(default=datetime.date(2019, 7, 18), verbose_name='Начало действия ВИП')),
