"""
Django settings for gamescumsite project.
...
SECRET_KEY = '#4pi95m!^f6*zb)(_h%uzxn0b41rc7f6wi_y3!a1$6d0+-a(@@'
...
ROOT_URLCONF = 'gamescumsite.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'authentication.context_processors.get_player_squad_info',
...
WSGI_APPLICATION = 'gamescumsite.wsgi.application'
...
SOCIAL_AUTH_STEAM_API_KEY = 'BD1EBFF1F1644726E7F1399B2E9FF8B4'
